        ...
        <div className="w-full max-w-md space-y-8 bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg transition-all">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              <h1 className="text-3xl font-bold mt-4 text-gray-800 dark:text-white">Welcome Back</h1>
              <p className="text-base text-gray-500 dark:text-gray-400">Sign in to your account</p>
            </div>
          </div>
